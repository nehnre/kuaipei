...
var imagesPath = "/Public/niceform/images/";
...
function replaceTextareas() {
	for(var q = 0; q < textareas.length; q++) {
		...
		bottomRight.style.width = container.style.width;
		// var bottomLeft = document.createElement('img');
		// bottomLeft.className = "NFTextareaBottomLeft";
		// bottomLeft.src = imagesPath + "0.png";
		var bottomLeft = document.createElement('div');
		bottomLeft.className = "textareadiv";
		//assemble divs
		...
		textareas[q].onfocus = function() {
			...
			this.parentNode.nextSibling.getElementsByTagName("div")[0].className = "textareadiv_xon";
		}
		textareas[q].onblur = function() {
			...
			this.parentNode.nextSibling.getElementsByTagName("div")[0].className = "textareadiv";
		}
	}
}
