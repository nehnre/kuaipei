...
<head> 
	...
	<script language="javascript" type="text/javascript" src="__PUBLIC__/js/Reg/authUserFactory.js"></script>
							...
							<td align="center"><form class="niceform" id="myForm">
								<table width="80%" border="0" cellspacing="0" cellpadding="0" id="formtable">
									...
									<tr>
										...
										<td><input type="text" id="company_name" name="company_name"  class="text_input input_normal" value="<?php echo ($result["company_name"]); ?>" /></td>
									</tr>
									<tr>
										<td><span class="red">*</span>　企业地址：</td>
										<td><input type="text" id="company_address" name="company_address"  class="text_input input_normal" value="<?php echo ($result["company_address"]); ?>" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" id="post_code" name="post_code"  class="text_input input_normal" size="20" value="<?php echo ($result["post_code"]); ?>" /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" id="link_man" name="link_man"  size="20"  class="text_input input_normal" value="<?php echo ($result["link_man"]); ?>" ></td>
									</tr>
									<tr>
										<td><span class="red">*</span>　营业范围：</td>
										<td><input type="text" id="business_scope" name="business_scope"  class="text_input input_normal" size="20" value="<?php echo ($result["business_scope"]); ?>" /></td>
									</tr>
									<tr>
										<td><span class="red">*</span>　企业规模：</td>
										<td>
											<select name="company_scale" size="1"  id="company_scale" >
									...
									<tr>
										<td><span class="red">*</span>　工商营业执照：</td>
										<td>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td width="270">
													...
													<td width="80"><input type="button" id="btnBL" name="btnBL" value="浏览" /></td>
													<td class="gray"> 提示：上传图片，限定2MB大小，JPG格式<input type="hidden" value="<?php echo ($result["business_license"]); ?>" name="business_license" id="business_license" /></td>
												</tr>											
											</table>
										</td>
									</tr>
									<tr id="tr_bl" style="display:none;height:200px">
										<td></td>
										<td>
											<?php if(!empty($result['business_license'])): ?><img src="/Public/Upload/<?php echo ($result["business_license"]); ?>" />
												<script type="text/javascript">
													bodyIncrease();	
													$("#tr_bl").show();
												</script><?php endif; ?>
									...
									<tr>
										<td><span class="red">*</span>　所在位置地图：</td>
										<td>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td width="270">
													...
													<td width="80"><input type="button" id="btnAP" value="浏览" /></td>
													<td class="gray"> 提示：上传图片，限定2MB大小，JPG格式<input type="hidden" value="<?php echo ($result["address_pic"]); ?>" name="address_pic" id="address_pic" /></td>
												</tr>
											</table>
										</td>
									</tr>
									<tr id="tr_ap" style="display:none;height:200px">
										<td></td>
										<td>
											<?php if(!empty($result['address_pic'])): ?><img src="/Public/Upload/<?php echo ($result["address_pic"]); ?>" />
												<script type="text/javascript">
													bodyIncrease();	
													$("#tr_ap").show();
												</script><?php endif; ?>
